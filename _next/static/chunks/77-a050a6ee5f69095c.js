    ...
    [77], {
        2077: function(e, r, t) {
            ...
            void 0 !== (n = "function" == typeof(i = function() {
                ...
                return (n = function(e) {
                    var r, t, a, l;
                    if (n.isNumeral(e)) r = e.value();
                    else if (0 === e || void 0 === e) r = 0;
                    else if (null === e || i.isNaN(e)) r = null;
                    else if ("string" == typeof e) {
                        if (u.zeroFormat && e === u.zeroFormat) r = 0;
                        else if (u.nullFormat && e === u.nullFormat || !e.replace(/[^0-9]+/g, "").length) r = null;
                        else {
                            for (t in o)
                                if ((l = "function" == typeof o[t].regexps.unformat ? o[t].regexps.unformat() : o[t].regexps.unformat) && e.match(l)) {
                                    a = o[t].unformat;
                                    break
                                }
                            r = (a = a || n._.stringToNumber)(e)
                        }
                    ...
                    numberToFormat: function(e, r, t) {
                        var i, o, l, u, s, c, f, m = a[n.options.currentLocale],
                            h = !1,
                            b = !1,
                            d = 0,
                            p = "",
                        ...
                        if (n._.includes(l, "-") && (l = l.slice(1), v = !0), l.length < d)
                            for (var _ = d - l.length; _ > 0; _--) l = "0" + l;
                        return c > -1 && (l = l.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + m.delimiters.thousands)), 0 === r.indexOf(".") && (l = ""), f = l + g + (p || ""), h ? f = (h && v ? "(" : "") + f + (h && v ? ")" : "") : s >= 0 ? f = 0 === s ? (v ? "-" : "+") + f : f + (v ? "-" : "+") : v && (f = "-" + f), f
                    },
                    stringToNumber: function(e) {
                        ...
                        if (u.zeroFormat && e === u.zeroFormat) t = 0;
                            ...
                            for (r in t = 1, "." !== i.delimiters.decimal && (e = e.replace(/\./g, "").replace(i.delimiters.decimal, ".")), l)
                                if (n = RegExp("[^a-zA-Z]" + i.abbreviations[r] + "(?:\\)|(\\" + i.currency.symbol + ")?(?:\\))?)?$"), o.match(n)) {
                                    t *= Math.pow(10, l[r]);
                                    break
                                }
                            t *= ((e.split("-").length + Math.min(e.split("(").length - 1, e.split(")").length - 1)) % 2 ? 1 : -1) * Number(e = e.replace(/[^0-9\.]+/g, ""))
                        }
                        return t
                    },
                    isNaN: function(e) {
                    ...
                    toFixed: function(e, r, t, n) {
                        var i, o, a, l, u = e.toString().split("."),
                            s = r - (n || 0);
                        return a = Math.pow(10, i = 2 === u.length ? Math.min(Math.max(u[1].length, s), r) : s), l = (t(e + "e+" + i) / a).toFixed(i), n > r - i && (o = RegExp("\\.?0{1," + (n - (r - i)) + "}$"), l = l.replace(o, "")), l
                    }
                }, n.options = u, n.formats = o, n.locales = a, n.locale = function(e) {
                ...
                }, n.register = function(e, r, t) {
                    if (r = r.toLowerCase(), this[e + "s"][r]) throw TypeError(r + " " + e + " already registered.");
                    ...
                    add: function(e) {
                        ...
                        return this._value = i.reduce([this._value, e], function(e, t, n, i) {
                            return e + Math.round(r * t)
                        }, 0) / r, this
                    },
                    subtract: function(e) {
                        var r = i.correctionFactor.call(null, this._value, e);
                        return this._value = i.reduce([e], function(e, t, n, i) {
                            return e - Math.round(r * t)
                        }, Math.round(this._value * r)) / r, this
                    },
                    multiply: function(e) {
                        return this._value = i.reduce([this._value, e], function(e, r, t, n) {
                            var o = i.correctionFactor(e, r);
                    ...
                    format: function(e, r, t) {
                        var i, o = n._.includes(r, " BPS") ? " " : "";
                        return e *= 1e4, r = r.replace(/\s?BPS/, ""), i = n._.numberToFormat(e, r, t), n._.includes(i, ")") ? ((i = i.split("")).splice(-1, 0, o + "BPS"), i = i.join("")) : i = i + o + "BPS", i
                    },
                    unformat: function(e) {
                ...
                }).suffixes.concat(r.suffixes.filter(function(r) {
                    return 0 > e.suffixes.indexOf(r)
                    ...
                    format: function(t, i, o) {
                        var a, l, u, s = n._.includes(i, "ib") ? r : e,
                            c = n._.includes(i, " b") || n._.includes(i, " ib") ? " " : "";
                        for (a = 0, i = i.replace(/\s?i?b/, ""); a <= s.suffixes.length; a++)
                            if (l = Math.pow(s.base, a), u = Math.pow(s.base, a + 1), null === t || 0 === t || t >= l && t < u) {
                                c += s.suffixes[a], l > 0 && (t /= l);
                                break
                            }
                        return n._.numberToFormat(t, i, o) + c
                    },
                    unformat: function(t) {
                        var i, o, a = n._.stringToNumber(t);
                        if (a) {
                            for (i = e.suffixes.length - 1; i >= 0; i--) {
                                if (n._.includes(t, e.suffixes[i])) {
                                    o = Math.pow(e.base, i);
                                    break
                                }
                                if (n._.includes(t, r.suffixes[i])) {
                                    o = Math.pow(r.base, i);
                                    break
                                }
                            }
                    ...
                    format: function(e, r, t) {
                        ...
                        for (r = r.replace(/\s?\$\s?/, ""), i = n._.numberToFormat(e, r, t), e >= 0 ? (l.before = l.before.replace(/[\-\(]/, ""), l.after = l.after.replace(/[\-\)]/, "")) : !(e < 0) || n._.includes(l.before, "-") || n._.includes(l.before, "(") || (l.before = "-" + l.before), o = 0; o < l.before.length; o++) switch (l.before[o]) {
                            case "$":
                        ...
                        for (o = l.after.length - 1; o >= 0; o--) switch (l.after[o]) {
                            case "$":
                                i = o === l.after.length - 1 ? i + a.currency.symbol : n._.insert(i, a.currency.symbol, -(l.after.length - (1 + o)));
                                break;
                            case " ":
                                i = o === l.after.length - 1 ? i + " " : n._.insert(i, " ", -(l.after.length - (1 + o) + a.currency.symbol.length - 1))
                        }
                        return i
                    }
                    ...
                    format: function(e, r, t) {
                        ...
                        return r = r.replace(/e[\+|\-]{1}0/, ""), n._.numberToFormat(Number(i[0]), r, t) + "e" + i[1]
                    },
                    unformat: function(e) {
                        var r = n._.includes(e, "e+") ? e.split("e+") : e.split("e-"),
                            t = Number(r[0]),
                            i = Number(r[1]);
                        return i = n._.includes(e, "e-") ? i *= -1 : i, n._.reduce([t, Math.pow(10, i)], function(e, r, t, i) {
                            var o = n._.correctionFactor(e, r);
                            return e * o * (r * o) / (o * o)
                        }, 1)
                    }
                    ...
                    format: function(e, r, t) {
                        var i = n.locales[n.options.currentLocale],
                            o = n._.includes(r, " o") ? " " : "";
                        return r = r.replace(/\s?o/, ""), o += i.ordinal(e), n._.numberToFormat(e, r, t) + o
                    }
                    ...
                    format: function(e, r, t) {
                        var i, o = n._.includes(r, " %") ? " " : "";
                        return n.options.scalePercentBy100 && (e *= 100), r = r.replace(/\s?\%/, ""), i = n._.numberToFormat(e, r, t), n._.includes(i, ")") ? ((i = i.split("")).splice(-1, 0, o + "%"), i = i.join("")) : i = i + o + "%", i
                    },
                    unformat: function(e) {
                        var r = n._.stringToNumber(e);
                        return n.options.scalePercentBy100 ? .01 * r : r
                    }
                    ...
                    unformat: function(e) {
                        var r = e.split(":"),
                            t = 0;
                        return 3 === r.length ? t += 3600 * Number(r[0]) + 60 * Number(r[1]) + Number(r[2]) : 2 === r.length && (t += 60 * Number(r[0]) + Number(r[1])), Number(t)
                    }
                }), n
            }) ? i.call(r, t, r, e) : i) && (e.exports = n)
        }
    }
]);